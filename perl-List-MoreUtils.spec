%{?scl:%scl_package perl-List-MoreUtils}
%{!?scl:%global pkg_name %{name}}

Name:		%{?scl_prefix}perl-List-MoreUtils
Version:	0.33
Release:	13.sc1%{?dist}
...
BuildRequires:	%{?scl_prefix}perl(Pod::Simple)
...
%changelog
* Thu Feb 13 2014 Jitka Plesnikova <jplesnik@redhat.com> - 0.33-13
- Removed useless filter of dependencies
- Resolves: rhbz#1064855

* Wed Nov 20 2013 Jitka Plesnikova <jplesnik@redhat.com> - 0.33-12
- Rebuilt for SCL
